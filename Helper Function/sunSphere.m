function [xx,yy,zz] = sunSphere(varargin)
...
%
%   EARTH_SPHERE(N) and EARTH_SPHERE without arguments graph the earth as a 
...
try
    myscale = 696340*Scale{2,strcmpi(Scale(1,:),units)};
catch %#ok<*CTCH>
